...
contract PolygonAddresses {
    ...
    // ERC20s
    address public USDC = address(0x3c499c542cEF5E3811e1192ce70d8cC03d5c3359);
    address public USDCe = address(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174);
    address public WETH = address(0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619);
    address public wstETH = address(0x03b54A6e9a984069379fae1a4fC4dBAE93B3bCCD);
    ...
    address public WSTETH = address(0x03b54A6e9a984069379fae1a4fC4dBAE93B3bCCD);
    address public CBETH = address(address(0));
    address public FRAX = address(0x104592a158490a9228070E0A8e5343B499e125D0);
    address public COMP = address(0x8505b9d2254A7Ae468c0E9dd10Ccea3A837aef5c);
    address public LINK = address(0xb0897686c545045aFc77CF20eC7A532E3120E0F1);
    address public LINKe = address(0x53E0bca35eC356BD5ddDFebbD1Fc0fD03FaBad39);
    address public MATICx = address(0xfa68FB4628DFF1028CFEc22b4162FCcd0d45efb6);
    address public stMATIC = address(0x3A58a54C066FdC0f2D55FC9C89F0415C92eBf3C4);
    ...
    // Redstone
    string public RPC_URL = "https://polygon-mainnet.g.alchemy.com/v2/YTZ4co0ktED8_pxzfX77Lqg9Z2z4SCX_";
}
