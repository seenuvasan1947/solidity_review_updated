...
contract ArbitrumAddresses {
    ...
    address public CVX = address(0xb952A807345991BD529FDded05009F5e80Fe8F45);
    ...
    address public camelotFactory = 0x6EcCab422D763aC031210895C81787E87B43A652;
    address public camelotUSDC_WETH_pool = 0x84652bb2539513BAf36e225c930Fdd8eaa63CE27;

    // Curve Pools and Tokens

    // Convex-Curve Platform Specifics
    address public convexArbitrumBooster = 0xF403C135812408BFbE8713b5A23a04b3D48AAE31;
    address public fraxUsdcLpToken = 0xC9B8a3FDECB9D5b218d02555a8Baf332E5B740d5;
    address public fraxUsdcConvexRewardBooster = 0x93729702Bf9E1687Ae2124e191B8fFbcC0C8A0B0;
    address public curveFraxUsdcPool = 0xC9B8a3FDECB9D5b218d02555a8Baf332E5B740d5;
    address public curveFraxUsdcGauge = 0x95285Ea6fF14F80A2fD3989a6bAb993Bd6b5fA13;
    // Deposit contract address	0xF403C135812408BFbE8713b5A23a04b3D48AAE31
    // Rewards contract address	0x93729702Bf9E1687Ae2124e191B8fFbcC0C8A0B0
    // Convex pool id	10
