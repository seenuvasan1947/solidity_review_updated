...
contract LZHelperSender is OAppSender {
    ...
    function updatePayInLZToken(bool _payInLZToken) public onlyOwner {
    ...
    function updateTVL(uint256 vaultId, uint256 tvl, uint256 updateTime) public {
        ...
        MessagingFee memory messageFee = _quote(lzChainId, data, messageSetting, payInLZToken);
        _lzSend(lzChainId, data, messageSetting, messageFee, payable(address(this))); // TODO: send event here
    }
}
